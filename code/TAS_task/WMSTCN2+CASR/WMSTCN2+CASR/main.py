...
# Need input
parser.add_argument('--num_epochs', default=148, type=int)      
...
vid_list_file = "/home/data/dukee/asrf-main/dataset/"+args.dataset+"/splits/train.split"+args.split+".bundle"
vid_list_file_tst = "/home/data/dukee/asrf-main/dataset/"+args.dataset+"/splits/test.split"+args.split+".bundle"
features_path = "/home/data/dukee/asrf-main/dataset/"+args.dataset+"/features/"
gt_path = "/home/data/dukee/asrf-main/dataset/"+args.dataset+"/groundTruth/"
